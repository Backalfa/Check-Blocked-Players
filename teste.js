       ...
       <tr>
          ...
          <td style="text-align: center">
             <a target="_blank" href="/game.php?village=${game_data.village.id}&screen=info_ally&id=${playerObject.tribe}">
                ${(playerObject.tribe).replace('90','S.T.').replace('28','PRDT').replace('54','S.O.C').replace('91','*****').replace('45','-[L]-').replace('1','PRDT').replace('3','LEGION').replace('4','LEGION').replace('8','PRDT')}
             </a>
          </td>
