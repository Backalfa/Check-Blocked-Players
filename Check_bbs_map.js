        ...
        <div id="main" class="ui-widget-content" style="background-color:${backgroundColor}">
            <table id="bonusVillages" class="vis" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}">
                <tr style="background-color:${backgroundColor}">
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/wood.png" style="width:48px;height:48px;" id="bb1"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/stone.png" style="width:48px;height:48px;" id="bb2"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/iron.png" style="width:48px;height:48px;" id="bb3"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/farm.png" style="width:48px;height:48px;" id="bb4"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/barracks.png" style="width:48px;height:48px;" id="bb5"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/stable.png" style="width:48px;height:48px;" role="button" id="bb6"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/garage.png" style="width:48px;height:48px;" role="button" id="bb7"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/all.png" style="width:48px;height:48px;" role="button" id="bb8"/>
                    </td>
                    <td style="text-align:center; width:auto; background-color:${baseColor}"><img src="graphic/bonus/storage.png" style="width:48px;height:48px;" role="button" id="bb9"/>
                    </td>
                </tr>
                <tr style="background-color:${backgroundColor}">
...
// Evento de clique para o botão com id "bb1"
$("#bb1").on("click", function() {
    displayArray(0); // Chama a função displayArray(0) quando o botão for clicado
});

// Evento de clique para o botão com id "bb2"
$("#bb2").on("click", function() {
    displayArray(1); // Chama a função displayArray(1) quando o botão for clicado
});

// Evento de clique para o botão com id "bb3"
$("#bb3").on("click", function() {
    displayArray(2); // Chama a função displayArray(2) quando o botão for clicado
});

// Evento de clique para o botão com id "bb4"
$("#bb4").on("click", function() {
    displayArray(3); // Chama a função displayArray(3) quando o botão for clicado
});

// Evento de clique para o botão com id "bb5"
$("#bb5").on("click", function() {
    displayArray(4); // Chama a função displayArray(4) quando o botão for clicado
});

// Evento de clique para o botão com id "bb6"
$("#bb6").on("click", function() {
    displayArray(5); // Chama a função displayArray(5) quando o botão for clicado
});

// Evento de clique para o botão com id "bb7"
$("#bb7").on("click", function() {
    displayArray(6); // Chama a função displayArray(6) quando o botão for clicado
});

// Evento de clique para o botão com id "bb8"
$("#bb8").on("click", function() {
    displayArray(7); // Chama a função displayArray(7) quando o botão for clicado
});

// Evento de clique para o botão com id "bb9"
$("#bb9").on("click", function() {
    displayArray(8); // Chama a função displayArray(8) quando o botão for clicado
});
